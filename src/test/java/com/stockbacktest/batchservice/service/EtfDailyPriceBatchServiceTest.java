...
class EtfDailyPriceBatchServiceTest {
    ...
    void Given_Null_ApiURL_When_GetDailyEtfsPrice_Then_Throw_NullPointerException(MockServerClient mockServerClient) throws Exception {
        // Arrange
    ...
    void Given_Null_Apikey_When_GetDailyEtfsPrice_Then_Throw_NullPointerException(MockServerClient mockServerClient) throws Exception {
        // Arrange
        EtfDailyPriceBatchService service = new EtfDailyPriceBatchService();
    ...
    void Given_Invalid_ApiURL_When_GetDailyEtfsPrice_Then_Throw_RuntimeException(MockServerClient mockServerClient) throws Exception {
        // Arrange
        EtfDailyPriceBatchService service = new EtfDailyPriceBatchService();
    ...
    void Given_Invalid_Apikey_When_GetDailyEtfsPrice_Then_Throw_RuntimeException(MockServerClient mockServerClient) throws Exception {
        // Arrange
        EtfDailyPriceBatchService service = new EtfDailyPriceBatchService();
    ...
    void Given_Null_Parameter_When_GetDailyEtfsPrice_Then_Throw_RuntimeException(MockServerClient mockServerClient) throws Exception {
        // Arrange
        EtfDailyPriceBatchService service = new EtfDailyPriceBatchService();
    ...
    void Given_500_Error_When_GetDailyEtfsPrice_Then_Throw_RuntimeException(MockServerClient mockServerClient) throws Exception {
        // Arrange
        EtfDailyPriceBatchService service = new EtfDailyPriceBatchService();
    ...
    void Given_ApiReturnsNull_When_GetDailyEtfsPrice_Then_Throw_IllegalStateException(MockServerClient mockServerClient) throws Exception {
        // Arrange
        EtfDailyPriceBatchService service = new EtfDailyPriceBatchService();
    ...
    void Given_Valid_Request_When_GetDailyEtfsPrice_Then_Returns_EtfPriceList(MockServerClient mockServerClient) throws Exception {
        // Arrange
        EtfDailyPriceBatchService service = new EtfDailyPriceBatchService();
